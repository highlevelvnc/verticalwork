...
export default function Contact() {
  ...
  return (
    <section ref={sectionRef} id="contacto" className="py-40 bg-background">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 xl:gap-24">
          ...
          <div className="contact-info lg:col-span-1">
            ...
            <h2 className="type-title text-content mb-6 leading-none">
              VAMOS<br />
              ELEVAR O SEU<br />
              <span className="text-orange">PROJETO.</span>
            </h2>

            <p className="type-spec text-electric mb-8">
              Orçamento sem compromisso
            </p>

            <p
              className="text-content-muted mb-10 leading-relaxed"
              style={{ fontFamily: 'var(--font-inter)', fontSize: '1.0625rem' }}
            >
              Contacte-nos para uma consultoria técnica detalhada.
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-surface-2 flex items-center justify-center shrink-0" aria-hidden>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#5AD9F4" strokeWidth="1.5">
          ...
          {/* Form */}
          <div className="contact-form lg:col-span-2 bg-surface-1 border border-white/5 p-10">
            <form
              className="space-y-8"
              onSubmit={(e) => {
                e.preventDefault()
                // TODO: Implement form submission (email service or API route)
              }}
            >
              ...
              <div>
                <label
                  ...
                  className="type-spec text-content-muted block mb-3"
                >
                  Tipo de Serviço
                </label>
                <select
                  id="tipo-servico"
                  className="w-full bg-background border-0 border-b-2 border-white/10 focus:border-orange text-content p-4 outline-none transition-colors appearance-none cursor-pointer"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-background border-0 border-b-2 border-white/10 focus:border-orange text-content p-4 outline-none transition-colors resize-none placeholder:text-content-muted/30"
                  style={{ fontFamily: 'var(--font-inter)' }}
                />
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                ...
                <p className="type-spec text-content-muted/30 text-xs">
...
function FormField({
  ...
  // Derive a clean id from the label (strips diacritics, lowercases, hyphenates)
  const id = label
    .toLowerCase()
    .normalize('NFD')
    .replace(/[\u0300-\u036f]/g, '')
  ...
  return (
    <div>
      <label htmlFor={id} className="type-spec text-content-muted block mb-3">
        {label}
      </label>
      <input
        id={id}
        ...
        className="w-full bg-background border-0 border-b-2 border-white/10 focus:border-orange text-content p-4 outline-none transition-colors placeholder:text-content-muted/30"
        style={{ fontFamily: 'var(--font-inter)' }}
      />
    </div>
  )
